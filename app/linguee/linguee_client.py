        ...
        *,
        ...
        for i in range(self.max_redirects):
            try:
                ...
                print(f"Error downloading URL: {error=}, {url=}")
            ...
            if isinstance(parse_result, ParseError):
                print(f"Parser returned parse error: {parse_result=}")
                return parse_result
            elif isinstance(parse_result, Correction):
                print(f"Parser returned correction: {parse_result=}")
                url = get_search_url(
                ...
                print("Parser returned not found")
                return ParseError(message="Translation not found")
            else:
                print(f"Unexpected API result: {parse_result=}")
